...
*/
    ...
    (function(a) {
        ...
        f.prototype = {
            ...
            search: function(a) {
                ...
                for (var e = [], f, g, h, l; b; ) {
                    ...
                    for (g = b.children.length; f < g; f++)
                        h = b.children[f],
                        l = b.fb ? d(h) : h,
                        u(a, l) && (b.fb ? c.push(h) : r(a, l) ? this.rh(h, c) : e.push(h));
                    b = e.pop()
                }
                return c
            },
            ...
            th: function(a, b, c, d) {
                ...
                d || (d = Math.ceil(Math.log(e) / Math.log(f)),
            ...
            yk: function(a) {
                for (var b = a.length - 1, c; 0 <= b; b--)
                    ...
                    c.splice(c.indexOf(a[b]), 1)) : this.clear() : g(a[b], this.xb)
            },
            Ak: function(a) {
                var b = ["return a", " - b", ";"];
    ...
    Nj.prototype.uc = function(a, b) {
        var c = this.state
          , d = c.lineWidth;
        void 0 !== c.strokeStyle && void 0 !== d && (Lj(this, c, this.pd),
        Ej(this, b),
    ...
    k.wa = function(a, b, c, d, e, f, g) {
        ...
        var l = 2 * d + 1
          ...
          , n = this.f;
        n.canvas.width !== l || n.canvas.height !== l ? (n.canvas.width = l,
        n.canvas.height = l) : n.clearRect(0, 0, l, l);
        if (void 0 !== this.i) {
            var p = Da();
            Ea(p, a);
            Fa(p, b * (this.i + d), p)
    ...
    k.$c = function(a) {
        ...
        this.c = null;
        this.i = !1;
        var p = new Vj(.5 * l / m,f,l,m,c.$,this.f,b.f);
        c.ae(f, l, g);
        a = function(a) {
            var c = a.ib();
            if (c)
